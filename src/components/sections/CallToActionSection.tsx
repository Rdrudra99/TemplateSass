   ...
   <div className="flex items-center justify-center bg-[url('https://shadcnblocks.com/images/block/circles.svg')] bg-cover bg-center px-8 py-20 text-center md:p-20">
    <div className="mx-auto max-w-screen-md">
     <h1 className="mb-4 text-balance text-3xl font-semibold md:text-5xl">
      {callToActionData?.title || "Start building your websites faster"}
     </h1>
     <p className="text-muted-foreground md:text-lg">
      {callToActionData?.description || "Try our tools and services to build your website faster. Start with a 14-day free trial. No credit card required. No setup fees. Cancel anytime."}
     </p>
